# CM-12.1 Device tree for Samsung GT-S7580 (kylepro)
...
### Specs (Physically inspected):
  ...
  - GPU: Broadcom VideoCore IV (? clock, 64MB VRAM from RAM)
...
### Notice:
  - Apply *PATCH_CM-12.1.diff* to root directory of CM-12.1 before build
